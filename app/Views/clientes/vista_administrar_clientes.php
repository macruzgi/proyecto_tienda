<div class="x_panel">
                  <div class="x_title">
                    <h2>Administraci&oacute;n de Clientes</small></h2>
                  ...
                  <div class="x_content">
                      <div class="row">
						  ...
						  <a class="btn btn-app" href="<?php echo base_url();?>/Vista_Agregar_Cliente">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                      <thead>
                        <tr role="row">
							...
							<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1"  aria-label="Office: activate to sort column ascending">Nombre</th>
							...
							<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Direcci&oacute;n</th>
					  ...
					  <tbody>
							<?php 
								foreach($Traer_Clientes as $Cliente_Encontrada){
							?>
							<tr>
								<td><?php echo $Cliente_Encontrada->id_cliente;?></td>
								
								<td><?php echo $Cliente_Encontrada->cli_codigo;?></td>
								<td><?php echo $Cliente_Encontrada->cli_nombre;?></td>
								<td><?php echo $Cliente_Encontrada->cli_telefono;?></td>
								<td><?php echo $Cliente_Encontrada->cli_direccion;?></td>
								
								<td>
									<div class="fa-hover col-md-3 col-sm-4  ">
										<h3><a href="<?php echo base_url();?>/Vista_Editar_Cliente/<?php echo $Cliente_Encontrada->id_cliente;?>" data-toggle="tooltip" data-placement="top" title data-original-title="Editar">
