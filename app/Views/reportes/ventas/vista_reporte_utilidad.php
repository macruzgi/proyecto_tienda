<div class="x_panel">
                  <div class="x_title">
                    <h2>Reporte de utilidad vrs. costo</h2>
					...
					<form id="frm_reporte_utilidad" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
						<div class="row">
								<div id="overlay">
						...
						<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button  id="btn_generar_reporte_utilidad" class="btn btn-success">Generar</button>
