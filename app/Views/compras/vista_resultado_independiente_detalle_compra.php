...
<div class="item form-group">
	...
	<div class="col-md-3 col-sm-3 ">
		<span class="form-control"><?php  if($Traer_Datos){ echo $Traer_Datos[0]->com_fecha_creacion;}?></span>
		
	</div>
	<label class="col-form-label col-md-2 col-sm-2 label-align" for="first-name">No. de documento<span class="required"></span>
	</label>
	<div class="col-md-3 col-sm-3 ">
		<span class="form-control"><?php  if($Traer_Datos){ echo $Traer_Datos[0]->com_numero_documednto;}?></span>
		
	</div>
</div>
<div class="item form-group">
	<label class="col-form-label col-md-2 col-sm-2 label-align" for="first-name">NRC<span class="required"></span>
	</label>
	<div class="col-md-3 col-sm-3 ">
		<span class="form-control"><?php if($Traer_Datos){ echo $Traer_Datos[0]->com_nrc;}?></span>
		
	</div>
	<label class="col-form-label col-md-2 col-sm-2 label-align" for="first-name">Proveedor<span class="required"></span>
	</label>
	<div class="col-md-3 col-sm-3 ">
		<span class="form-control"><?php if($Traer_Datos){ echo $Traer_Datos[0]->com_razon_social;}?></span>
...
<table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                       ...
                       <tr role="row" class="odd">
                          ...
                          <td><?php echo $Dato_Encontrado->det_cantidad;?></td>
                          <td style="text-align:right;">$&nbsp;<?php echo $Dato_Encontrado->det_precio;?></td>
                          <td style="text-align:right;">$&nbsp;<?php echo $Dato_Encontrado->det_sub_total;?></td>
						...
						<tr>
							...
							<td style="text-align:right;"><h2>$&nbsp;<?php echo $Dato_Encontrado->com_total;?></h2></td>
						</tr>
					 </tbody>
                    </table>