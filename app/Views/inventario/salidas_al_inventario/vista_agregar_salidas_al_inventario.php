<div class="x_panel">
                  <div class="x_title">
                    <h2>Agregar Salida al Inventario</h2>
					...
					<div class="x_content">
					<form id="frm_agregar_salida_al_inventario" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
						<div class="row">
						<div class="col-md-12">
								  ...
								  Espere por favor...</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="sa_numero_documento" name="sa_numero_documento" required="required" class="form-control " autocomplete="off">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="sa_comentario" class="form-control" name="sa_comentario" ></textarea>
							...
							<div class="col-md-12">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="buscar_producto_salida" class="form-control" type="text" name="buscar_producto_salida" autocomplete="off" placeholder="Digite coincidencias para buscar un producto">
											</div>
										</div>
