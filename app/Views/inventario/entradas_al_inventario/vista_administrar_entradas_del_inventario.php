<div class="x_panel">
                  <div class="x_title">
                    <h2>Administraci&oacute;n de Entradas al inventario</h2>
                  ...
                  <div class="x_content">
                      <div class="row">
						  ...
						  <a class="btn btn-app" href="<?php echo base_url();?>/Inventario/Vista_Agregar_Entrada_Al_Inventario">
							<i class="fa fa-plus-square"></i> Agregar Entrada al inventario
						  </a>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
					  ...
					  <tbody>
							...
							?>
							<tr>
								<td><?php echo $Dato_Encontrado->id_entrada;?></td>
								<td><?php echo $Dato_Encontrado->en_numero_documento;?></td>
								<td><?php echo $Dato_Encontrado->en_comentario;?></td>
								<td><?php echo $Dato_Encontrado->en_fecha_creacion;?></td>
								<td><?php echo $Dato_Encontrado->en_total;?></td>
								<td><?php echo $Dato_Encontrado->nombre." (".$Dato_Encontrado->nombreusuario.")";?></td>
																<td>
								<div class="fa-hover col-md-3 col-sm-4  ">
								<h3><a  href="#" onClick="Traer_Detalle_Entrada_Inventario('<?php echo $Dato_Encontrado->id_entrada;?>'); event.preventDefault();" data-toggle="tooltip" data-placement="top" title data-original-title="Ver">
			  ...
			  <!--inicio de la modal-->
				<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true" id="modal_entrada_inventario">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">

                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel">Detalle de la entrada al inventario</h4>
                    ...
                    <p class="text-muted font-13 m-b-30">
						...
						<div id="tbl_entrada_elegida"></div>
                  </div>
                        </div>
