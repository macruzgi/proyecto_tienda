<div class="x_panel">
                  <div class="x_title">
                    <h2>Administraci&oacute;n de Facturas</small></h2>
                  ...
                  <div class="x_content">
                      <div class="row">
						  ...
						  <a class="btn btn-app" href="<?php echo base_url();?>/Ventas/Nueva_Venta">
							<i class="fa fa-plus-square"></i> Agregar Pre-factura
						  </a>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                      <thead>
                        <tr role="row">
							...
							<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1"  aria-label="Position: activate to sort column ascending">Fecha</th>
					  ...
					  <tbody>
							...
							<tr>
								...
								<td>
									<div class="fa-hover col-md-3 col-sm-4  mr-3"><h3><a href="<?php echo base_url();?>/Ventas/Imprimir_Factura/<?php echo $Dato_Encontrado->id_factura;?>" data-toggle="tooltip" data-placement="top" title data-original-title="Re-imprimir"><i class="fa fa-print"></i></a></h3>
									</div> 
									<div class="fa-hover col-md-3 col-sm-4  "><h3><a href="#" onclick="Traer_Detalle_Venta('<?php echo $Dato_Encontrado->id_factura;?>', 1); event.preventDefault();" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ver">
